package com.yitu.clientconsumer.rest;

import com.yitu.clientconsumer.hystrix.HystrixClientConfigration;
 ...
 */
@FeignClient(name = "yitu-client-provider", configuration = HystrixClientConfigration.class)
